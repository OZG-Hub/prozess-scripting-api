...
public class FormSectionV1 {
  ...
  @SuppressWarnings("all")
  FormSectionV1(final String title, @NotNull final List<FieldGroupV1> fieldGroups) {
    this.title = title;
  ...
  public static class FormSectionV1Builder {
     ...
     */
    @SuppressWarnings("all")
    public FormSectionV1.FormSectionV1Builder fieldGroups(@NotNull final List<FieldGroupV1> fieldGroups) {
   ...
   */
  @SuppressWarnings("all")
  public void setFieldGroups(@NotNull final List<FieldGroupV1> fieldGroups) {
    this.fieldGroups = fieldGroups;
  }
