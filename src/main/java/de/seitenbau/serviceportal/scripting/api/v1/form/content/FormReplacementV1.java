...
public class FormReplacementV1 {
  ...
  FormReplacementV1(@NotNull final String template, @NotNull final ReturnType returnType) {
  ...
  public static class FormReplacementV1Builder {
     ...
     */
    @SuppressWarnings("all")
    public FormReplacementV1.FormReplacementV1Builder template(@NotNull final String template) {
      this.template = template;
      return this;
    }
     ...
     */
    @SuppressWarnings("all")
    public FormReplacementV1.FormReplacementV1Builder returnType(@NotNull final ReturnType returnType) {
      this.returnType = returnType;
      return this;
    }
   ...
   */
  @SuppressWarnings("all")
  public void setTemplate(@NotNull final String template) {
    this.template = template;
  }
   ...
   */
  @SuppressWarnings("all")
  public void setReturnType(@NotNull final ReturnType returnType) {
    this.returnType = returnType;
  }
