...
public abstract class AbstractFieldGroupV1 {
  ...
  public static abstract class AbstractFieldGroupV1Builder<C extends AbstractFieldGroupV1, B extends AbstractFieldGroupV1.AbstractFieldGroupV1Builder<C, B>> {
     ...
     */
    @SuppressWarnings("all")
    public B id(@NotNull final String id) {
      this.id = id;
      return self();
    }
     ...
     */
    @SuppressWarnings("all")
    public B rows(@NotNull final List<FormRowV1> rows) {
     ...
     */
    @SuppressWarnings("all")
    public B displayConditions(@NotNull final List<DisplayConditionV1> displayConditions) {
   ...
   */
  @SuppressWarnings("all")
  public void setRows(@NotNull final List<FormRowV1> rows) {
    this.rows = rows;
  }
