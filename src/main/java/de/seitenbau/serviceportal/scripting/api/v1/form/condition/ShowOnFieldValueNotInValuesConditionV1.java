...
public class ShowOnFieldValueNotInValuesConditionV1 extends FieldDisplayConditionV1 {
  ...
  @SuppressWarnings("all")
  @lombok.Generated
  public ShowOnFieldValueNotInValuesConditionV1() {
    this.values = ShowOnFieldValueNotInValuesConditionV1.$default$values();
  }

  /**
   * Creates a new {@code ShowOnFieldValueNotInValuesConditionV1} instance.
   *
   * @param values Werte, für die das Zielfeld nicht angezeigt wird.
   */
  @SuppressWarnings("all")
  @lombok.Generated
  public ShowOnFieldValueNotInValuesConditionV1(final Set<String> values) {
    this.values = values;
  }
}
