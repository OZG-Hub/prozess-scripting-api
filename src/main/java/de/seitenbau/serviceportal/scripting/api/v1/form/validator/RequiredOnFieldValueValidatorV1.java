...
public class RequiredOnFieldValueValidatorV1 extends ConditionalFieldValidationRuleV1 {
  ...
  @SuppressWarnings("all")
  @lombok.Generated
  public RequiredOnFieldValueValidatorV1() {
  }

  /**
   * Creates a new {@code RequiredOnFieldValueValidatorV1} instance.
   *
   * @param values Werte des referenzierten Feldes, bei denen das Feld zum Pflichtfeld wird.
   */
  @SuppressWarnings("all")
  @lombok.Generated
  public RequiredOnFieldValueValidatorV1(final Set<Object> values) {
    this.values = values;
  }
}
