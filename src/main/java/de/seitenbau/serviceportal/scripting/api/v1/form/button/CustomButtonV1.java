...
public class CustomButtonV1 {
  ...
  @SuppressWarnings("all")
  @lombok.Generated
  public CustomButtonV1(final String label, final String value, final String helptext, final Boolean primary, final boolean wasPressed, final boolean skipValidation) {
    this.label = label;
    this.value = value;
    this.helptext = helptext;
    this.primary = primary;
