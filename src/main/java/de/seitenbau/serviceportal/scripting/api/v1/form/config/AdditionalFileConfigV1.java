...
public class AdditionalFileConfigV1 implements AdditionalFieldConfigV1 {
  ...
  @SuppressWarnings("all")
  @lombok.Generated
  public AdditionalFileConfigV1(final boolean compress, final boolean disableExternalUploadHint, final StorageConfigV1 storage) {
    this.compress = compress;
    this.disableExternalUploadHint = disableExternalUploadHint;
    this.storage = storage;
  }
