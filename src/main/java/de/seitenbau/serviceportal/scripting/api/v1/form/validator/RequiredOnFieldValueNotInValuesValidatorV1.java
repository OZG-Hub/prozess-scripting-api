...
public class RequiredOnFieldValueNotInValuesValidatorV1 extends ConditionalFieldValidationRuleV1 {
  ...
  @SuppressWarnings("all")
  @lombok.Generated
  public RequiredOnFieldValueNotInValuesValidatorV1() {
  }

  /**
   * Creates a new {@code RequiredOnFieldValueNotInValuesValidatorV1} instance.
   *
   * @param values Werte des referenzierten Feldes, bei denen das Feld nicht zum Pflichtfeld wird.
   */
  @SuppressWarnings("all")
  @lombok.Generated
  public RequiredOnFieldValueNotInValuesValidatorV1(final Set<Object> values) {
    this.values = values;
  }
}
