...
public class FormRowV1 implements Cloneable {
  ...
  public static class FormRowV1Builder {
     ...
     */
    @SuppressWarnings("all")
    public FormRowV1.FormRowV1Builder fields(@NotNull final List<FormFieldV1> fields) {
   ...
   */
  @SuppressWarnings("all")
  public void setFields(@NotNull final List<FormFieldV1> fields) {
    this.fields = fields;
  }
  ...
  @SuppressWarnings("all")
  public FormRowV1(@NotNull final List<FormFieldV1> fields) {
    this.fields = fields;
  }
}
