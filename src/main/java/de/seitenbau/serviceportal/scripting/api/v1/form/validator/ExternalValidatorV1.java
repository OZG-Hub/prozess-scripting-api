...
public class ExternalValidatorV1 extends ValidationRuleV1 {
   ...
   */
  private DynamicDataSourcePropertiesV1 settings;
  ...
  public static abstract class ExternalValidatorV1Builder<C extends ExternalValidatorV1, B extends ExternalValidatorV1.ExternalValidatorV1Builder<C, B>> extends ValidationRuleV1.ValidationRuleV1Builder<C, B> {
    ...
    @SuppressWarnings("all")
    @lombok.Generated
    public B settings(final DynamicDataSourcePropertiesV1 settings) {
  ...
  @SuppressWarnings("all")
  @lombok.Generated
  public DynamicDataSourcePropertiesV1 getSettings() {
  ...
  @SuppressWarnings("all")
  @lombok.Generated
  public void setSettings(final DynamicDataSourcePropertiesV1 settings) {
    this.settings = settings;
  }
