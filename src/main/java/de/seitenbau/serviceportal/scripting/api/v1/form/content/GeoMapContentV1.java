...
public class GeoMapContentV1 {
  ...
  GeoMapContentV1(final String data, final FileReferenceV1 file, final String json) {
    this.data = data;
    this.file = file;
    this.json = json;
  }
  ...
  public static class GeoMapContentV1Builder {
    ...
    public GeoMapContentV1 build() {
      return new GeoMapContentV1(this.data, this.file, this.json);
    }

    @Override
    @SuppressWarnings("all")
    public String toString() {
      return "GeoMapContentV1.GeoMapContentV1Builder(data=" + this.data + ", file=" + this.file + ", json=" + this.json + ")";
    }
  }
  ...
  @SuppressWarnings("all")
  public String toString() {
    return "GeoMapContentV1(data=" + this.getData() + ", file=" + this.getFile() + ", json=" + this.getJson() + ")";
  }
}
