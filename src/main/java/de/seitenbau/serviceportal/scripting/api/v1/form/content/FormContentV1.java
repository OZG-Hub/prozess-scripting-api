...
public class FormContentV1 {
  ...
  public static class FormContentV1Builder {
     ...
     */
    @SuppressWarnings("all")
    public FormContentV1.FormContentV1Builder formId(@NotNull final String formId) {
      this.formId = formId;
      return this;
    }
     ...
     */
    @SuppressWarnings("all")
    public FormContentV1.FormContentV1Builder fields(@NotNull final Map<String, FormFieldContentV1> fields) {
     ...
     */
    @SuppressWarnings("all")
    public FormContentV1.FormContentV1Builder validationMessages(@NotNull final List<ValidationMessageV1> validationMessages) {
   ...
   */
  @SuppressWarnings("all")
  public void setFormId(@NotNull final String formId) {
    this.formId = formId;
  }
   ...
   */
  @SuppressWarnings("all")
  public void setFields(@NotNull final Map<String, FormFieldContentV1> fields) {
    this.fields = fields;
  }
   ...
   */
  @SuppressWarnings("all")
  public void setValidationMessages(@NotNull final List<ValidationMessageV1> validationMessages) {
  ...
  @SuppressWarnings("all")
  private FormContentV1(@NotNull final String formId, final String formTitle, final Map<String, Object> context, @NotNull final Map<String, FormFieldContentV1> fields, @NotNull final List<ValidationMessageV1> validationMessages, final String pressedCustomButton, final Date createdOn, final FormReplacementValuesV1 appliedReplacements) {
    this.formId = formId;
    this.formTitle = formTitle;
    this.context = context;
    this.fields = fields;
