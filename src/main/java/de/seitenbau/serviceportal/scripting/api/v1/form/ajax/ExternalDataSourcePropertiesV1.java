...
public class ExternalDataSourcePropertiesV1 implements Cloneable {
   ...
   * Für DOWNLOAD-Felder kann ein ServiceAlias verwendet werden.
   */
  @NotNull
  private String url;
  /**
  ...
  /**
   * Map der HTTP-Header die beim AJAX-Request gesetzt werden sollen. Die Header müssen der Allowlist
  ...
  /**
   * Name der Variable aus der gelesen werden soll. Nur für DOWNLOAD-Felder.
   */
  ...
  public static class ExternalDataSourcePropertiesV1Builder {
     ...
     */
    @SuppressWarnings("all")
    public ExternalDataSourcePropertiesV1.ExternalDataSourcePropertiesV1Builder url(@NotNull final String url) {
      this.url = url;
      return this;
    }
     ...
     */
    @SuppressWarnings("all")
    public ExternalDataSourcePropertiesV1.ExternalDataSourcePropertiesV1Builder scope(@NotNull final AjaxRequestIncludedFieldsScopeV1 scope) {
      this.scope = scope;
      return this;
    }
   ...
   */
  @SuppressWarnings("all")
  public void setScope(@NotNull final AjaxRequestIncludedFieldsScopeV1 scope) {
    this.scope = scope;
  }
  ...
  @SuppressWarnings("all")
  private ExternalDataSourcePropertiesV1(@NotNull final String url, final String proxyHost, final Integer proxyPort, final Map<String, String> headers, @NotNull final AjaxRequestIncludedFieldsScopeV1 scope, final List<FormFieldKeyV1> fieldIds, final String variableName) {
    this.url = url;
    this.proxyHost = proxyHost;
    this.proxyPort = proxyPort;
    this.headers = headers;
