...
public class DataResourcePointerV1 implements Cloneable {
  ...
  public static class DataResourcePointerV1Builder {
     ...
     */
    @SuppressWarnings("all")
    public DataResourcePointerV1.DataResourcePointerV1Builder service(final String service) {
     ...
     */
    @SuppressWarnings("all")
    public DataResourcePointerV1.DataResourcePointerV1Builder variableName(final String variableName) {
  ...
  @SuppressWarnings("all")
  public DataResourcePointerV1(final String service, final String variableName) {
    this.service = service;
    this.variableName = variableName;
  }
}
