...
public class DataResourcePointerV1 implements Cloneable {
  ...
  public static class DataResourcePointerV1Builder {
     ...
     */
    @SuppressWarnings("all")
    public DataResourcePointerV1.DataResourcePointerV1Builder service(@NotNull final String service) {
     ...
     */
    @SuppressWarnings("all")
    public DataResourcePointerV1.DataResourcePointerV1Builder variableName(@NotNull final String variableName) {
   ...
   */
  @SuppressWarnings("all")
  public void setVariableName(@NotNull final String variableName) {
    this.variableName = variableName;
  }
  ...
  @SuppressWarnings("all")
  public DataResourcePointerV1(@NotNull final String service, @NotNull final String variableName) {
    this.service = service;
    this.variableName = variableName;
  }
}
