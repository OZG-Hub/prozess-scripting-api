...
public class NumberValidatorV1 extends ValidationRuleV1 {
  ...
  @SuppressWarnings("all")
  @lombok.Generated
  public NumberValidatorV1() {
  }

  /**
   * Creates a new {@code NumberValidatorV1} instance.
   *
   * @param nonNegative {@code true}, wenn die Zahl nicht negativ sein darf.
   * @param digitsAfterDecimalPoint Maximale Anzahl an Dezimalstellen.
   * @param validationDecimalPointError Der benutzerdefinierte Fehlertext bei zu vielen Dezimalstellen.
   * @param validationNonNegativeNumberError Der benutzerdefinierte Fehlertext bei Verwendung einer negativen Zahl.
   */
  @SuppressWarnings("all")
  @lombok.Generated
  public NumberValidatorV1(final Boolean nonNegative, final Integer digitsAfterDecimalPoint, final String validationDecimalPointError, final String validationNonNegativeNumberError) {
    this.nonNegative = nonNegative;
    this.digitsAfterDecimalPoint = digitsAfterDecimalPoint;
    this.validationDecimalPointError = validationDecimalPointError;
    this.validationNonNegativeNumberError = validationNonNegativeNumberError;
