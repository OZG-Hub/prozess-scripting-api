...
public class FormFieldV1 implements Cloneable {
   ...
   * der Feldgruppe gesetzt sein.
   * <br/>
   * {@code PDF}, wenn das Feld in einem erzeugten PDF dargestellt werden soll.
   * {@code FORM}, wenn das Feld in der Formularansicht dargestellt werden soll.
  ...
  public boolean isFilled() {
    ...
    if (type.isListType() && value instanceof List<?> tmp) {
      return !tmp.isEmpty();
    }
  ...
  public static class FormFieldV1Builder {
    ...
    @SuppressWarnings("all")
    @lombok.Generated
    public FormFieldV1.FormFieldV1Builder renderFor(final List<DisplayModeV1> renderFor) {
