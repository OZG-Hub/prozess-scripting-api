...
public class FormFieldV1 implements Cloneable {
   ...
   * Für {@link FieldTypeV1#DOWNLOAD Download-Felder} ein Pflichtattribut.
   */
  ...
  public static class FormFieldV1Builder {
     ...
     */
    @SuppressWarnings("all")
    public FormFieldV1.FormFieldV1Builder id(@NotNull final String id) {
      this.id = id;
      return this;
    }
     ...
     */
    @SuppressWarnings("all")
    public FormFieldV1.FormFieldV1Builder type(@NotNull final FieldTypeV1 type) {
      this.type = type;
      return this;
    }
     ...
     */
    @SuppressWarnings("all")
    public FormFieldV1.FormFieldV1Builder displayConditions(@NotNull final List<DisplayConditionV1> displayConditions) {
     ...
     */
    @SuppressWarnings("all")
    public FormFieldV1.FormFieldV1Builder validationRules(@NotNull final List<ValidationRuleV1> validationRules) {
     ...
     */
    @SuppressWarnings("all")
    public FormFieldV1.FormFieldV1Builder validationMessages(@NotNull final Set<ValidationMessageV1> validationMessages) {
   ...
   */
  @SuppressWarnings("all")
  public void setType(@NotNull final FieldTypeV1 type) {
    this.type = type;
  }
   ...
   */
  @SuppressWarnings("all")
  public void setDisplayConditions(@NotNull final List<DisplayConditionV1> displayConditions) {
   ...
   */
  @SuppressWarnings("all")
  public void setValidationRules(@NotNull final List<ValidationRuleV1> validationRules) {
   ...
   */
  @SuppressWarnings("all")
  public void setValidationMessages(@NotNull final Set<ValidationMessageV1> validationMessages) {
  ...
  @SuppressWarnings("all")
  private FormFieldV1(@NotNull final String id, final String label, @NotNull final FieldTypeV1 type, final Object value, final String placeholder, final Boolean disabled, final Boolean required, final Boolean pickerDisabled, final Boolean consent, final String requiredValidationFailedMessage, final String typeValidationFailedMessage, final String thousandsSeparatorValidationFailedMessage, final String digitsAfterDecimalPointValidationFailedMessage, final String helptext, final List<PossibleValueV1> possibleValues, @NotNull final List<DisplayConditionV1> displayConditions, final int width, final String layout, @NotNull final List<ValidationRuleV1> validationRules, @NotNull final Set<ValidationMessageV1> validationMessages, final DataResourcePointerV1 source, final DataResourcePointerV1 target, final DataResourcePointerV1 possibleValuesSource, final ExternalDataSourcePropertiesV1 externalDataSourceProperties, final ExternalDataSourcePropertiesV1 externalValue, final Boolean filterable, final Map<String, String> controlParameters, final FormFieldKeyV1 initializeWithAdressField, final AdditionalFieldConfigV1 additionalConfig, final ModalHelpDialogV1 helpDialog) {
    this.id = id;
    this.label = label;
    this.type = type;
    this.value = value;
