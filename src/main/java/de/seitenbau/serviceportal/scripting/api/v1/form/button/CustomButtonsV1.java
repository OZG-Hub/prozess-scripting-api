...
public class CustomButtonsV1 {
  ...
  public static class CustomButtonsV1Builder {
     ...
     */
    @SuppressWarnings("all")
    public CustomButtonsV1.CustomButtonsV1Builder buttons(@NotNull final List<CustomButtonV1> buttons) {
   ...
   */
  @SuppressWarnings("all")
  public void setButtons(@NotNull final List<CustomButtonV1> buttons) {
  ...
  @SuppressWarnings("all")
  private CustomButtonsV1(@NotNull final List<CustomButtonV1> buttons, final DataResourcePointerV1 target) {
    this.buttons = buttons;
    this.target = target;
  }
}
