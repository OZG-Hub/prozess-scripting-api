...
public class FormV1 {
  ...
  public static class FormV1Builder {
     ...
     */
    @SuppressWarnings("all")
    public FormV1.FormV1Builder id(@NotNull final String id) {
      this.id = id;
      return this;
    }
     ...
     */
    @SuppressWarnings("all")
    public FormV1.FormV1Builder sections(@NotNull final List<FormSectionV1> sections) {
     ...
     */
    @SuppressWarnings("all")
    public FormV1.FormV1Builder validationMessages(@NotNull final Set<ValidationMessageV1> validationMessages) {
   ...
   */
  @SuppressWarnings("all")
  public void setSections(@NotNull final List<FormSectionV1> sections) {
  ...
  @SuppressWarnings("all")
  private FormV1(@NotNull final String id, final String title, final String language, @NotNull final List<FormSectionV1> sections, final DataResourcePointerV1 source, final DataResourcePointerV1 target, @NotNull final Set<ValidationMessageV1> validationMessages, final Map<String, Object> context, final CustomButtonsV1 customButtons, final FormReplacementValuesV1 appliedReplacements) {
    this.id = id;
    this.title = title;
    this.language = language;
    this.sections = sections;
