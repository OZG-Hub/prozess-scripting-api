...
public class FormFieldKeyV1 {
  ...
  public static class FormFieldKeyV1Builder {
     ...
     */
    @SuppressWarnings("all")
    public FormFieldKeyV1.FormFieldKeyV1Builder groupId(final String groupId) {
     ...
     */
    @SuppressWarnings("all")
    public FormFieldKeyV1.FormFieldKeyV1Builder fieldId(final String fieldId) {
  ...
  @SuppressWarnings("all")
  public FormFieldKeyV1(final String groupId, final int groupIndex, final String fieldId) {
    this.groupId = groupId;
    this.groupIndex = groupIndex;
    this.fieldId = fieldId;
  }
