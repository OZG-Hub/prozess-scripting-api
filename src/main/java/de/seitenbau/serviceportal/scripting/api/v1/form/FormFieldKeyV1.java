...
public class FormFieldKeyV1 {
  ...
  public static class FormFieldKeyV1Builder {
     ...
     */
    @SuppressWarnings("all")
    public FormFieldKeyV1.FormFieldKeyV1Builder groupId(@NotNull final String groupId) {
     ...
     */
    @SuppressWarnings("all")
    public FormFieldKeyV1.FormFieldKeyV1Builder fieldId(@NotNull final String fieldId) {
  ...
  @SuppressWarnings("all")
  public FormFieldKeyV1(@NotNull final String groupId, final int groupIndex, @NotNull final String fieldId) {
    this.groupId = groupId;
    this.groupIndex = groupIndex;
    this.fieldId = fieldId;
  }
