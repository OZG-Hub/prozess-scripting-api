...
public class BerlinPaymentConfigV1 implements PaymentConfigV1 {
  ...
  public static class BerlinPaymentConfigV1Builder {
    ...
    public BerlinPaymentConfigV1 build() {
      return new BerlinPaymentConfigV1(this.transPrefix, this.username, this.password, this.authId, this.authPassword);
    }

    @Override
    @SuppressWarnings("all")
    public String toString() {
      return "BerlinPaymentConfigV1.BerlinPaymentConfigV1Builder(transPrefix=" + this.transPrefix + ", username=" + this.username + ", password=" + this.password + ", authId=" + this.authId + ", authPassword=" + this.authPassword + ")";
    }
  }
  ...
  @SuppressWarnings("all")
  public String toString() {
    return "BerlinPaymentConfigV1(provider=" + this.getProvider() + ", transPrefix=" + this.getTransPrefix() + ", username=" + this.getUsername() + ", password=" + this.getPassword() + ", authId=" + this.getAuthId() + ", authPassword=" + this.getAuthPassword() + ")";
  }
  ...
  @SuppressWarnings("all")
  public BerlinPaymentConfigV1(final String transPrefix, final String username, final String password, final String authId, final String authPassword) {
    this.transPrefix = transPrefix;
    this.username = username;
    this.password = password;
    this.authId = authId;
