...
public class KfzKennzeichenStylingV1 implements AdditionalFieldStylingV1 {
  ...
  @SuppressWarnings("all")
  @lombok.Generated
  public KfzKennzeichenStylingV1() {
  }
  ...
  @SuppressWarnings("all")
  @lombok.Generated
  public KfzKennzeichenStylingV1(final Boolean electric, final Boolean historic, final String saisonStart, final String saisonEnd, final KfzKennzeichenTypeV1 kennzeichenType) {
    this.electric = electric;
    this.historic = historic;
    this.saisonStart = saisonStart;
    this.saisonEnd = saisonEnd;
